...
export const Scene01Hero: React.FC<Props> = ({ onNavigate, onRunDemo }) => {
  return (
    <section className="relative w-full h-[100svh] overflow-hidden bg-charcoal-900 flex flex-col justify-center">
      ...
      <div className="relative z-10 px-4 md:px-12 lg:px-24 flex flex-col items-start gap-8">
